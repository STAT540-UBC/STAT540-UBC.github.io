...
seminarPathInInstructorsOnly = 'seminars/seminars_winter_2019'
seminarPathGithubIO = 'seminars/seminars_winter_2019'
...
# Import schedule
rawdat <- read.csv(file.path("../course-admin", "schedule_2019.csv"), stringsAsFactors = FALSE, colClasses = list(course = 'factor', dow = 'factor'))
