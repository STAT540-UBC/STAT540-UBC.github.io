...
seminarPathInInstructorsOnly = 'seminars/seminars_winter_2017'
seminarPathGithubIO = here('seminars/seminars_winter_2017')

unlink(seminarPathGithubIO, force = TRUE, recursive = TRUE)
...
dir.create(dirname(seminarPathGithubIO),showWarnings = FALSE,recursive = TRUE)
file.copy(basename(seminarPathInInstructorsOnly), dirname(seminarPathGithubIO),recursive = TRUE)
...
**Supplemental materials** 
  ...
  * [seminar 0b](https://github.com/STAT540-UBC/STAT540-UBC.github.io/blob/master/seminars/seminars_winter_2017/seminar0b/seminar0b.html) Molecular biology review
