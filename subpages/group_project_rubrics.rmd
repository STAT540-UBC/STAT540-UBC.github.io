...
- Create subdirectories for different parts of your analyses. Provide a `README.md` file for each subdirectory to summarize its contents and analyses. For example:
...
![Example of a group repository directory structure](images/group_repo.png)
