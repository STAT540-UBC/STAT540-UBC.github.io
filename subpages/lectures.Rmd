...
cmdat <-
  data.frame(pdf = list.files(path="../lectures/lectures_2021", pattern = '^lect.*pdf', full.names=TRUE),
             stringsAsFactors = FALSE)
cmdath <-
  data.frame(html = list.files(path="../lectures/lectures_2021", pattern = '^lect.*html', full.names=TRUE),
             stringsAsFactors = FALSE)
