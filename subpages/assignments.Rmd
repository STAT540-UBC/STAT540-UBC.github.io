...
- Five( out of 10) in-seminar submissions (10 pts; 2 points each)
...
**GitHub**
You all have a private repository in STAT540-UBC organization account, i.e., the repo `zz_lastname-firstnmae_STAT540_2019`. We assume that 
...
**IMPORTANT NOTE**: use the repository within the organization assigned to you to submit all your course work (i.e., the repo `zz_lastname-firstname_STAT540_2019`). Do not use branches or other repositories.
  
**Set-up your private GitHub repo for homework**

  * We're talking about the repo `zz_lastname-firstnmae_STAT540_2019` now.
...
**How to "turn in" your homework**
  ...
  * Open an issue, link to the latest commit, tag us
    ...
    - In the description of the issue, tag all TAs by including the text `@STAT540-UBC/ta_2019`, and paste the revision SHA. You can also include a link to the markdown file as well. 
...
> If you're concerned that something hasn't gone right with the submission, send Sina, Jasper and Shams (sjafarzadeh@cmmt.ubc.ca, jjasperwong_123@hotmail.com, shamsbhuiyan92@gmail.com) an e-mail with your assignment attached. **Note**: this is *only* an emergency back-up plan. We will pester and work with you until you eventually get it submitted via GitHub.
