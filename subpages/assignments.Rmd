...
2. Open an issue in your private repo the the appropriate commit tagged, include a link to your Markdown file, and tag current TAs with @STAT540-UBC/current_tas
...
2. **Open an issue, link to the latest commit, tag us**: 
    ...
    - Paste the revision SHA, and include a link to the markdown file as well. 
