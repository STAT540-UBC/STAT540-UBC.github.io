...
- You will submit "deliverables" for seminars 1, 2 (split into two parts), 3, 4, and 6
...
- For more details on the project components abd how groups are selected see the [course work page](https://stat540-ubc.github.io/subpages/assignments.html#final-group-project)
- For detailed grading rubrics of the final project components, see the [final project rubric page](https://stat540-ubc.github.io/subpages/group_project_rubrics.html) and the [final project presentation rubric](https://raw.githubusercontent.com/STAT540-UBC/STAT540-UBC.github.io/master/homework/posterRubric2012.pdf)
