...
If we allow very complicated predictors, we could **overfit** fit training data
...
* A main analysis goal is to **identify** features / covariates that are **important** in predicting the response 
...
* As before, tuning parameter $\lambda$ controls the strength of the penalty and is selected with nested CV
  * What happens at $\lambda = 0$ and $\lambda = \infty$?
