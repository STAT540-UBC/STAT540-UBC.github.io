...
author: Sarah Merrill and Keegan Korthauer
date: "2021/01/20 <br><br> <font size=5> Slides by: Sarah Merrill, Sara Mostafavi, and Keegan Korthauer </font>"
output:
...
```{r, out.width=460, echo = FALSE, fig.align="center", out.width="460"}
knitr::include_graphics("img/empirical_rule.png")
```

<small><small><a href="By Melikamp - Own work, CC BY-SA 4.0" style="color:grey;">Image source: By Melikamp - Own work, CC BY-SA 4.0</a>
