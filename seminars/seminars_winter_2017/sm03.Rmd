...
Sometimes geoquery can not work depending on the , so if this doesn't work for you, you can download the expression and meta data files [here](https://github.com/STAT540-UBC/STAT540-UBC.github.io/tree/master/seminars/seminars_winter_2017/Seminar3), and continue with the rest of the assignment.
...
*Make a density plot using geom_density() of the p-value distributions of the above t-test. It should look like this:*
