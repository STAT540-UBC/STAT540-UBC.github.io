...
**IMPORTANT EDIT:** Due to a change in the GEO, the getGEO functions below no longer work
Please download your data from [this](https://www.dropbox.com/s/vkijisly8zwxkk9/methyl_ALL.Rdata?dl=0) link and place it next to your rmd file to be able
...
```{r aggregate_old, echo=T, eval=FALSE}
...
```{r stripplot, warning=F, message=F, eval=F}
...
```{r coord_old, warning=F, message=F, eval=F}
