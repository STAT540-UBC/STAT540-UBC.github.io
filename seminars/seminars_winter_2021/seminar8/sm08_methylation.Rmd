...
> For an overview of DNA methylation analysis, you may wish to review [this slide deck from last year](https://github.com/STAT540-UBC/STAT540-UBC.github.io/blob/master/lectures/archive/lectures_2020/lect17_Methylation.pdf). Unfortunately, we had to cut a lecture this year due to a decrease in teaching days, so we weren't able to cover this topic in lecture. 
