...
From there, you can switch the version of R used by R studio by navigating to Tools > Global Options > R Version  > Change... and selecting the correct version of R: 
![Global Options Tab](seminar_7_images/global_options.png)
