---
title: 'STAT 540 - Assignment 2 - Differential Expression Analysis'
...
* When you create a linear model, what is the underlying assumptions you are making about the distribution of the data (this question is multiple choice)?
	a) All expression values are normally distributed
	b) The residuals of the fitted model are normally distributed 
