...
subtitle: "'Downstream' Analysis: from counts to Differential Expression"
...
**Note:** *For submitting your assignment, please refer to the section [**STAT 540 Homework Submission Instructions**](https://stat540-ubc.github.io/subpages/assignments.html#stat-540-homework-submission-instructions) on the [**Coursework**](https://stat540-ubc.github.io/subpages/assignments.html) webpage.*
...
- Find the expression profile for the gene *OAS* (Ensembl ID ENSG00000089127). Make a scatterplot with hours post-infection on the x-axis and expression value in log2(CPM + 1) on the y-axis. Color the data points by infection status. Add in a regression line for each cell type.
